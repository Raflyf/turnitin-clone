...
def process_document(file_id, filepath, original_filename, exclude_quotes=True, exclude_biblio=True, exclude_small=False):
    ...
    try:
        ...
        print(f"[!] Mencari kandidat dari web (Mode Deep Search: 150 Kalimat Panjang)...")
        urls, preloaded_corpus = get_candidate_urls(sentences, max_probes=150, progress_cb=ddg_progress)
